...
bl_info = {
    "name": "ModelMod MMOBJ format",
    "author": "Campbell Barton, Bastien Montagne, John Quigley (ModelMod extensions only)",
    "version": (2, 0, 0),
    "blender": (3, 0, 0),
    "location": "File > Import-Export",
    "description": "Import-Export MMOBJ, Import MMOBJ mesh, UVs, materials and textures",
    "warning": "",
...
if "bpy" in locals():
    import importlib
    if "import_mmobj" in locals():
        importlib.reload(import_mmobj)
    if "export_mmobj" in locals():
        importlib.reload(export_mmobj)
...
class ImportOBJ(bpy.types.Operator, ImportHelper):
    """Load a ModelMod MMOBJ File"""
    bl_idname = "import_scene.mmobj"
    bl_label = "Import MMOBJ"
    ...
    def execute(self, context):
        ...
        return import_mmobj.load(context, **keywords)
...
class OBJ_PT_import_transform(bpy.types.Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "IMPORT_SCENE_OT_mmobj"
...
class ExportOBJ(bpy.types.Operator, ExportHelper):
    """Save a ModelMod MMOBJ File"""

    bl_idname = "export_scene.mmobj"
    bl_label = 'Export MMOBJ'
    bl_options = {'PRESET'}
    ...
    # MMOBJ requires triangles and doesn't understand the other stuff
    ...
    def execute(self, context):
        ...
        # Fros comment: Axis conversion is handled by other classes
        keywords["global_matrix"] = global_matrix
        return export_mmobj.save(context, **keywords)
...
class OBJ_PT_export_transform(bpy.types.Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "EXPORT_SCENE_OT_mmobj"
...
def menu_func_import(self, context):
    self.layout.operator(ImportOBJ.bl_idname, text="ModelMod obj (.mmobj)")


def menu_func_export(self, context):
    self.layout.operator(ExportOBJ.bl_idname, text="ModelMod obj (.mmobj)")

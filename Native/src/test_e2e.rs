...
use winapi::shared::minwindef::{LPARAM, WPARAM, UINT, LRESULT};
use winapi::shared::windef::{HWND};
use winapi::um::winuser::{WM_DESTROY, MSG, PostQuitMessage, DefWindowProcA,TranslateMessage,DispatchMessageA,PeekMessageA,PM_REMOVE};
...
fn create_test_window() -> HWND {
    ...
    let hwnd = unsafe {
        ...
        let hwnd = CreateWindowExA(0, t1.as_ptr(), t2.as_ptr(),
	        WS_OVERLAPPEDWINDOW, 100, 100, 640, 480,
	        desktop, null_mut(), wndclass.hInstance, null_mut() );
...
fn test_e2e() {
    ...
    let hr = unsafe {
        (*d3d9).CreateDevice( D3DADAPTER_DEFAULT,  D3DDEVTYPE_HAL, hwnd, D3DCREATE_HARDWARE_VERTEXPROCESSING, &mut pp, &mut pDevice)
    };
    ...
    unsafe {
        ...
        loop {
            ...
            if elapsed.unwrap().as_secs() > 25 { // TODO let test signal end 
                break;
            }
